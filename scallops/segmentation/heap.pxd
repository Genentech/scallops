...
cdef inline int smaller(unsigned int a, unsigned int b, Heap *h) noexcept nogil:
    cdef unsigned int k
...
cdef inline void swap(unsigned int a, unsigned int b, Heap *h) noexcept nogil:
...
cdef inline void heappop(Heap *heap,
                         np.int32_t *dest) noexcept nogil:
...
cdef inline void heappush(Heap *heap,
                          np.int32_t *new_elem) noexcept nogil:
